...
func (c *userServiceClient) GetByEmail(ctx context.Context, in *EmailRequest, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
...
func (UnimplementedUserServiceServer) GetByEmail(context.Context, *EmailRequest) (*User, error) {
